...
#define MCP_POT_NONE_CMD          0x30
  ...
  //       HARDWARE SPI
MCP_POT::MCP_POT(uint8_t select, __SPI_CLASS__ * mySPI)
{
  _pmCount  = 2;
  _select   = select;
  _dataOut  = 255;
...
//       SOFTWARE SPI
MCP_POT::MCP_POT(uint8_t select, uint8_t dataOut, uint8_t clock)
{
  _pmCount  = 2;
  _select   = select;
...
//
MCP41010::MCP41010(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 1;
  _maxOhm  = 10000;
}

MCP41010::MCP41010(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 1;
  _maxOhm  = 10000;
}

MCP41050::MCP41050(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 1;
  _maxOhm  = 50000;
...
MCP41050::MCP41050(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 1;
  _maxOhm  = 10000;
...
MCP41100::MCP41100(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 1;
  _maxOhm  = 100000;
...
MCP41100::MCP41100(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 1;
  _maxOhm  = 100000;
...
//
MCP42010::MCP42010(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 2;
  _maxOhm  = 10000;
...
MCP42010::MCP42010(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 2;
  _maxOhm  = 10000;
...
MCP42050::MCP42050(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 2;
  _maxOhm  = 50000;
...
MCP42050::MCP42050(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 2;
  _maxOhm  = 50000;
...
MCP42100::MCP42100(uint8_t select, __SPI_CLASS__ * mySPI)
        :MCP_POT(select, mySPI)
{
  _pmCount = 2;
  _maxOhm  = 100000;
...
MCP42100::MCP42100(uint8_t select, uint8_t dataOut, uint8_t clock)
        :MCP_POT(select, dataOut, clock)
{
  _pmCount = 2;
  _maxOhm  = 100000;
