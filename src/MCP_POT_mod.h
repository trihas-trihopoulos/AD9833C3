...
public:
  //       HARDWARE SPI
  MCP_POT(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  //       SOFTWARE SPI
  MCP_POT(uint8_t select, uint8_t dataOut, uint8_t clock);
...
{
public:
  MCP41010(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP41010(uint8_t select, uint8_t dataOut, uint8_t clock);
};

class MCP41050 : public MCP_POT
{
public:
  MCP41050(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP41050(uint8_t select, uint8_t dataOut, uint8_t clock);
};

class MCP41100 : public MCP_POT
{
public:
  MCP41100(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP41100(uint8_t select, uint8_t dataOut, uint8_t clock);
};
...
{
public:
  MCP42010(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP42010(uint8_t select, uint8_t dataOut, uint8_t clock);
};

class MCP42050 : public MCP_POT
{
public:
  MCP42050(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP42050(uint8_t select, uint8_t dataOut, uint8_t clock);
};

class MCP42100 : public MCP_POT
{
public:
  MCP42100(uint8_t select, __SPI_CLASS__ * mySPI = &SPI);
  MCP42100(uint8_t select, uint8_t dataOut, uint8_t clock);
};
